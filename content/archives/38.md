...
draft: false
---
本篇规范是 [PSR-1](http://blog.phpha.com/archives/37/) 基本代码规范的继承与扩展。

关键词 “必须”("MUST")、“一定不可/一定不能”("MUST NOT")、“需要”("REQUIRED")、 “将会”("SHALL")、“不会”("SHALL NOT")、“应该”("SHOULD")、“不该”("SHOULD NOT")、 “推荐”("RECOMMENDED")、“可以”("MAY")和”可选“("OPTIONAL")的详细描述可参见 [RFC 2119](http://www.ietf.org/rfc/rfc2119.txt) 。

<!--more-->

## 1. 概览

代码必须遵循 [PSR-1](http://blog.phpha.com/archives/37/) 中的编码规范 。
...
代码必须符合 [PSR-1](http://blog.phpha.com/archives/37/) 中的所有规范。
